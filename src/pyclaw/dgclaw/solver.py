...
class DGClawSolver(Solver):
    r"""
    Superclass for all DGClawND solvers.
    ...
    def __init__(self,riemann_solver=None,claw_package=None):
        r"""
        Set default options for DGClawSolvers and call the super's __init__().
        """
        self.limiters = [1]
        ...
        super(DGClawSolver,self).__init__(riemann_solver,claw_package)
    ...
    def setup(self,solution):
        ...
        if self.kernel_language=='Fortran':
            if self.fmod is None:
                so_name = 'clawpack.pyclaw.dgclaw.dgclaw'+str(self.num_dim)
                self.fmod = __import__(so_name,fromlist=['clawpack.pyclaw.dgclaw'])
    ...
    def dq_hyperbolic(self,state):
        raise NotImplementedError('You must subclass DGClawSolver.')
    ...
    def set_fortran_parameters(self,state,clawparams,workspace,reconstruct):
        """
        Set parameters for Fortran modules used by DGClaw.
    ...
    def allocate_rk_stages(self,solution):
        ...
        This routine is only used by method-of-lines solvers (DGClaw),
...
# ========================================================================
class DGClawSolver1D(DGClawSolver):
# ========================================================================
    """
    DGClaw solver for one-dimensional problems.
    
    Used to solve 1D hyperbolic systems using the DGClaw algorithms,
    which are based on WENO reconstruction and Runge-Kutta time stepping.
    """
    def __init__(self,riemann_solver=None,claw_package=None):
        r"""
        See :class:`DGClawSolver1D` for more info.
        """   
        self.num_dim = 1
        super(DGClawSolver1D,self).__init__(riemann_solver,claw_package)
...
# ========================================================================
class DGClawSolver2D(DGClawSolver):
# ========================================================================
    """DGClaw evolution routine in 2D
    
    This class represents the 2D DGClaw solver.  Note that there are 
    routines here for interfacing with the fortran time stepping routines only.
    """
    def __init__(self,riemann_solver=None,claw_package=None):
        r"""
        Create 2D DGClaw solver
        
        See :class:`DGClawSolver2D` for more info.
        """   
        self.num_dim = 2

        super(DGClawSolver2D,self).__init__(riemann_solver,claw_package)
